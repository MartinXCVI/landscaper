  ...
  <section class="home-landing" id="home-landing"> 
    ...
    <section class="home-columns">
      <section class="subcontainer-left">
        <section class="inner-subcontainer-left" data-aos="fade-right" data-aos-duration="1500">
        </section>
      </section>
        ...
        <section class="article-container">
          ...
          <article>
            ...
            <div class="article-card" data-aos="fade-up" data-aos-duration="1500">
              <i class="fa-brands fa-pagelines home-intro-icon"></i>
              <h4 class="title">
                957
              </h4>
              <p class="caps text-grey">Completed<br/> projects in 2023</p>
            </div>
          </article>
        </section>
      ...
      <section class="subcontainer-right over-x">
        <section class="inner-subcontainer-right" data-aos="fade-left" data-aos-duration="1500">
        </section>
      </section>
